...
function displayZedRunToolsFrame(){
    const startIndex = 'https://knowyourhorses.com/horses/'.length;
    const horseTokenId =  location.href.substring(startIndex); 
    const iFrame = document.createElement('iframe');
    iFrame.classList.add('zedrunToolsIFrame','card');
    iFrame.src = `https://zedrun.tools/race-analysis/${horseTokenId}`;
